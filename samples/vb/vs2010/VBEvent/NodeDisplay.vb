Public Class NodeDisplay
    ...
    Public Delegate Sub AddStatusDelegate(ByVal funcName As String, ByVal errorCode As Kvaser.CanLib.Canlib.canStatus)
    ...
    Public Sub DisplayStatusInfo(ByVal funcName As String, ByVal errorCode As Kvaser.CanLib.Canlib.canStatus)
...
Public Class ReceiveNode
    ...
    Public Sub Run()
        ...
        ChannelHandle = Kvaser.CanLib.Canlib.canOpenChannel(0, Kvaser.CanLib.Canlib.canOPEN_ACCEPT_VIRTUAL)
        ...
        status = Kvaser.CanLib.Canlib.canIoCtl(ChannelHandle, Kvaser.CanLib.Canlib.canIOCTL_GET_EVENTHANDLE, winHandle)
        ...
        Do While (NotShutdown And (Not myForm.RequestShutdownStatus()))
            ...
            If (System.Threading.WaitHandle.WaitAny(waitHandles, 1000, False) = 0) Then
                ...
                Do
                    status = Kvaser.CanLib.Canlib.canRead(ChannelHandle, id, data, dlc, flag, time)
                    If (status = Kvaser.CanLib.Canlib.canStatus.canOK) Then
                        If ((flag And Kvaser.CanLib.Canlib.canMSG_ERROR_FRAME) = 0) Then
                ...
                If (status <> Kvaser.CanLib.Canlib.canStatus.canERR_NOMSG) Then
