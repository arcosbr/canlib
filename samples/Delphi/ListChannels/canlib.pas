unit canlib;
//
// Copyright 1995-2024 by KVASER AB
...
const
  ...
  canMSG_RESERVED_FOR_EXTENDING = $80000000;
  ...
  canCHANNEL_CAP_CANTEGRITY = $10000000;
  ...
  DIAG_ANALYZER_TYPE_DEFAULT = 0;
  DIAG_PROGRAM_TYPE_NORMAL = 0;
  DIAG_PROGRAM_TYPE_AUTOBAUD = 1;
  DIAG_PROGRAM_TYPE_HALT = 2;
  DIAG_PROGRAM_TYPE_GENERIC = 3;
  DIAG_PROGRAM_STATE_UNKNOWN = 0;
  DIAG_PROGRAM_STATE_RUNNING = 1;
  DIAG_PROGRAM_STATE_STOPPED = 2;
...
type
  ...
  Pbitrate_t = ^bitrate_t;
  Pbitrates_t = ^bitrates_t;
  PkvDiagSample = ^kvDiagSample;
  PkvAnalyzerInfo_t = ^kvAnalyzerInfo_t;
  ...
  kvBusParamLimits = record
    ...
    version: Integer;
    arbitration_min: kvBusParamsTq;
    arbitration_max: kvBusParamsTq;
    data_min: kvBusParamsTq;
    data_max: kvBusParamsTq;
  end;
  ...
  _anonymous_type_2 = record
    ...
    time: Int64;
    /// CAN data
    data: array [0..63] of UTF8Char;
    /// CAN flags, \ref canMSG_STD, \ref canMSG_EXT, \ref canMSG_RTR
    flag: Integer;
    /// CAN DLC
    dlc: Integer;
  end;
  ...
  _anonymous_type_3 = record
    ...
    startValue: Integer;
    /// Number of edges in \a edgeTimes
    edgeCount: Integer;
    /// Time since previous edge in analyzer ticks at \a sampleFreq
    edgeTimes: array [0..8191] of Integer;
  end;
   ...
   *)
  kvDiagSample = record
    header: _anonymous_type_1;
    msg: _anonymous_type_2;
    sample: _anonymous_type_3;
  end;

  kvAnalyzerInfo_t = record
    analyzerNo: Integer;
    &type: Integer;
 ...
 *)
function kvBitrateToBusParamsTq(hnd: canHandle; freq: Integer; nominal: PkvBusParamsTq): canStatus; stdcall;
 ...
 *)
function kvBitrateToBusParamsFdTq(hnd: canHandle; freqA: Integer; freqD: Integer; arbitration: PkvBusParamsTq; data: PkvBusParamsTq): canStatus; stdcall;
 ...
 *)
function kvDiagGetNumberOfAnalyzers(canHnd: canHandle; analyzerCount: PInteger): canStatus; stdcall;
  external canlib32 name _PU + 'kvDiagGetNumberOfAnalyzers';
 ...
 *)
function kvDiagGetAnalyzerInfo(canHnd: canHandle; info: PkvAnalyzerInfo_t): canStatus; stdcall;
  external canlib32 name _PU + 'kvDiagGetAnalyzerInfo';
 ...
 *)
function kvDiagAttachAnalyzer(canHnd: canHandle; &type: Integer): canStatus; stdcall;
  external canlib32 name _PU + 'kvDiagAttachAnalyzer';
 ...
 *)
function kvDiagDetachAnalyzer(canHnd: canHandle): canStatus; stdcall;
  external canlib32 name _PU + 'kvDiagDetachAnalyzer';
 ...
 * \return \ref canERR_xxx (negative) if failure.
 *)
function kvDiagSetProgram(canHnd: canHandle; programType: Integer; configBuffer: PUTF8Char): canStatus; stdcall;
  external canlib32 name _PU + 'kvDiagSetProgram';
 ...
 * \sa \ref kvDiagStop()
 *)
function kvDiagStart(canHnd: canHandle): canStatus; stdcall;
  external canlib32 name _PU + 'kvDiagStart';
 ...
 * \sa \ref kvDiagStart()
 *)
function kvDiagStop(canHnd: canHandle): canStatus; stdcall;
  external canlib32 name _PU + 'kvDiagStop';
 ...
 *)
function kvDiagReadSample(canHnd: canHandle; sample: PkvDiagSample): canStatus; stdcall;
  external canlib32 name _PU + 'kvDiagReadSample';
 ...
 *)
function kvDiagReadSampleWait(canHnd: canHandle; sample: PkvDiagSample; timeout: Integer): canStatus; stdcall;
  external canlib32 name _PU + 'kvDiagReadSampleWait';
 ...
 *)
function kvDiagCalculateBitrate(canHnd: canHandle; btr: Pbitrates_t): canStatus; stdcall;
  external canlib32 name _PU + 'kvDiagCalculateBitrate';
 ...
 *)
function kvDiagResetBitrateCalculation(canHnd: canHandle): canStatus; stdcall;
  external canlib32 name _PU + 'kvDiagResetBitrateCalculation';
 ...
 *)
function kvDiagCalculateClockOffset(canHnd: canHandle; id: Integer; fMin: PDouble; fMax: PDouble; fMean: PDouble; fStd: PDouble; n: PInteger): canStatus; stdcall;
  external canlib32 name _PU + 'kvDiagCalculateClockOffset';
 ...
 *)
function kvDiagResetClockOffsetCalculation(canHnd: canHandle): canStatus; stdcall;
  external canlib32 name _PU + 'kvDiagResetClockOffsetCalculation';
