...
namespace DBdump
{
    class dumper
    {
        ...
        //Displays info about a database signal
        ...
        //Displays info about a database message
        ...
        //Displays all data in a database
        static void dumpDatabase(Kvadblib.Hnd dh)
        {
            string name;
            DisplayError(Kvadblib.GetDatabaseName(dh, out name), "GetDatabaseName");
            Console.WriteLine("Database name: {0}", name);
        ...
        //Create a new database and add some messages and signals to it
