...
namespace LinViewer
{
   class LinManipulator
   {
      ...
      public void BusOn(Int32 chanNum, Int32 nType, Int32 varLen, Int32 enhCKSum, Int32 bitsPerSec)
      {
         if (!CurOnBus)
         {
            channelNum = chanNum;
      ...
      public void AdjustBusParameters(Int32 varLen, Int32 enhCKSum, Int32 bitsPerSec)
      {
         if (CurOnBus)
         {
            varLength = varLen;
      ...
      private void InitChannel()
      {
         ...
         if ((status = Linlib.linGetCanHandle(linHandle, out canHandle)) != Linlib.LinStatus.linOK)
         {
         ...
         if ((status = Linlib.linSetupLIN(linHandle, (varLength & enhanceCKSum), bps)) != 
      ...
      private void ProcessReceivedMessages()
      {
         ...
         while ((status = Linlib.linReadMessage(linHandle, out msgId, msgData, out dlc, out flags, msgInfo))
                  == Linlib.LinStatus.linOK)
         {
            // Process data
